...
export default function SingleProductSkeleton() {
  return (
    <section className="flex flex-col px-14 bg-white">
      <section className="w-full flex gap-3 px-4  py-6">
        <div className="w-1/3 h-[400px] bg-[#f1f3f6] animate-pulse"></div>
        <div className="py-8 flex flex-col w-2/3 bg-[#ffffff] animate-pulse gap-6 px-8">
      ...
      <div className="w-full h-[80px] px-14 bg-[#f1f3f6] animate-pulse"></div>
